...
- AniXplore is developed based on the existing framework of [IMDLBenCo](https://github.com/scu-zjz/IMDLBenCo), and utilizes codes from existing IMDL models cited in the AnimeDL-2M paper.
